...
const AnimatedLink = ({ to, children, className = "" }) => {
  return (
    <Link
      to={to}
      className={`group relative cursor-pointer inline-flex h-12 items-center justify-center overflow-hidden rounded-lg bg-neutral-950 px-6 font-medium text-neutral-200 transition-all duration-200 hover:scale-105 ${className}`}
    >
      <span>{children}</span>
